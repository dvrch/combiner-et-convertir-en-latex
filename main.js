...
`;
            ...
            for (let i = 0; i < lines.length; i++) {
              if (acc + lines[i].length + 1 > charIndex) {
                lineIndex = i;
                break;
              }
